...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Println()
		fmt.Println("Usage:")
		fmt.Println("  webscan [options] <URL>")
		fmt.Println()
		fmt.Println("Options:")
		flag.PrintDefaults()
		fmt.Println()
		fmt.Println("Profiles:")
		fmt.Println("  quick    pemeriksaan dasar")
		fmt.Println("  full     pemeriksaan lengkap")
		fmt.Println()
		fmt.Println("Examples:")
		fmt.Println("  webscan https://example.com")
		fmt.Println("  webscan --profile quick https://example.com")
		fmt.Println("  webscan --profile full --report https://example.com")
